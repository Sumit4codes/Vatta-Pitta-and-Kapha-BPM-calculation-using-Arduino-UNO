...
try:
    ...
    colect_time=time.time() - start_time
...
## duration = float(input("Enter the duration of data collection (in seconds): "))
vatta1= int(vatta_bpm)
pitta1= int(pitta_bpm)
duration=int(colect_time)

# Save data to Excel
save_to_excel(name, phone, duration, vatta1, pitta1)
